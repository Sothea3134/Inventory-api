...
@section('title'){{'Import Create'}}@endsection
@section('css')
<style>
    INPUT:not(:autofill),
    SELECT:not(:autofill),
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" data-date-format="DD/MM/YYYY" name="date" style="border: none;font-size: 14px;font-weight: 400;color: #B5B2B2;" id="date" value="{{old('date')}}" required>
