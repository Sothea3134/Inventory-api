...
@section('title'){{'Report - Product Sale'}}@endsection
@section('css')
<style>
    .import-text-color {
        color: #9E9E9E;
    ...
    <div class="row">
        <form action="{{url('reports/filter')}}" method="POST">
            ...
            <div class="d-flex justify-content-between">
                <p style="font-size: 15px; margin-left:35px;"><span style="color:#4EA6D7;">Reports</span><span style="color: #B8B8B8; margin: 0 10px;">/</span><span style="color: #B8B8B8;">Product Sales</span></p>
                <div class="mb-3 row">
                    <label for="sale_date" class="col-sm-3 col-form-labe label-font d-flex align-items-center">Sale Date:</label>
                    <div class="col-sm-6">
                        <input type="date" class="form-control" data-date-format="DD/MM/YYYY" name="sale_date" style="border: none;font-size: 14px;font-weight: 400;color: #B5B2B2; height:40px;" id="date" value="{{$saleDate}}">
                    </div>
                ...
                <a class="btn btn-primary d-flex justify-content-center" style="background-color: #1F5A92; text-transform: none;  border-radius: 0; width:80px; height:40px;" type="button" href="{{url('reports/product-sales')}}">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr style="background-color: #FAFAFA; border-left-width:1px;border-right-width:1px;">
                ...
                <td class="import-text-color-body">{{date('d F y',strtotime($report->sale_date))}}</td>
